package id.ac.poliban.mi.rafii.aplikasikalkulator;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        EditText etAngkaPertama = findViewById(R.id.etFirstNumber);
        EditText etAngkaKedua = findViewById(R.id.etSecondNumber);
